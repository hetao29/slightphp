...
### v3.1更新如下
  ...
  - 优化SDb,SRedis，增加错误连接重置，可以更好的支持[WorkerMan](https://github.com/hetao29/slightphp/blob/master/wiki/Workerman.md),[Swoole](https://github.com/hetao29/slightphp/blob/master/wiki/Swoole.md)
